...
# Pulling just the latitude and londitude values from the computational mass field lat and lon grids
...
dsout.close()
print('Creating plot of new landmask...')
# Plot the new landmask
...
# This will plot slightly larger than the area of interest
# Be sure that in the set_extent you have the proper ordering
# of longitudes, then latitudes.
#ax.set_extent([-80,-93,45,50])
ax.coastlines('50m',edgecolor='black',linewidth=0.75)
ax.add_feature(states_provinces,edgecolor='black',linewidth=0.5)
plt.scatter(lon,lat,landmask_out[0,:,:],c='k',marker='+')
# Make some titles
plt.title('Area of interest',loc='left')
#plt.show()
plt.savefig('no_lake_landmask.png',dpi=150)
