...
sct_dom_out[0, mask is True] = sct_dom_out[0, ilat_lnd, ilon_lnd]
landmask_out[0, mask is True] = 1
soiltemp_out[0, mask is True] = soiltemp_out[0, ilat_lnd, ilon_lnd]
slopecat_out[0, mask is True] = slopecat_out[0, ilat_lnd, ilon_lnd]
scb_dom_out[0, mask is True] = scb_dom_out[0, ilat_lnd, ilon_lnd]
...
snoalb_out[0, mask is True] = snoalb_out[0, ilat_lnd, ilon_lnd]
...
lake_depth_out[0, mask is True] = lake_depth_out[0, ilat_lnd, ilon_lnd]
